...
public class userServiceImpl implements UserService {
   ...
   private UserRepo userRepo;
    ...
    public User saveUsers(User user) {
        ...
        String linkFromVerification = Helper.getLinkFromVerification(Token);

        emailServices.sendEmail(saveUser.getEmail(),"Verification link : Smart Contact Manager",linkFromVerification);
